...
#   neuromesh_subject1_sulc_t4.png
#   neuromesh_subject1_sulc_t9.png
#   neuromesh_subject1_sulc_lateral_lh.png
...
scimesh::write_png(img_t4, "neuromesh_subject1_sulc_t4.png")
cat("  -> neuromesh_subject1_sulc_t4.png  (", img_t4$width, "x", img_t4$height, ")\n", sep = "")
...
scimesh::write_png(img_t9, "neuromesh_subject1_sulc_t9.png")
cat("  -> neuromesh_subject1_sulc_t9.png  (", img_t9$width, "x", img_t9$height, ")\n", sep = "")
...
scimesh::write_png(img_lat, "neuromesh_subject1_sulc_lateral_lh.png")
cat("  -> neuromesh_subject1_sulc_lateral_lh.png  (", img_lat$width, "x", img_lat$height, ")\n", sep = "")
...
scimesh::write_png(img_t4v, "neuromesh_subject1_sulc_t4_vertical.png")
cat("  -> neuromesh_subject1_sulc_t4_vertical.png  (", img_t4v$width, "x", img_t4v$height, ")\n", sep = "")
